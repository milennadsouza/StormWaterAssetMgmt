...
namespace Stormwater_Analysis
{
    ...
    class Pipe
    {
        ...
        public int Est_Life { get;  set; }// Cast Iron, Corrugated Metal with Tar Lining, HDPE, PVC, Concrete - 75 years / Masonry, Corrugated Iron - 50 years
        ...
        public int PipeLife(TypesOfMaterials mater)
        {
